<template>
  <span>
    <div class="row">
      <div id="left-column" class="col-9">
        <div class="card-deck">
          <div class="card">
          ...
          <div class="card">
            <div class="card-header">Labs News <i class="float-right cil-newspaper"></i></div>
            <div class="card-body">
              <ul>
        ...
        <div class="card-deck mt-2">
          ...
          <div class="card">
            <div class="card-header">
              Schedule of Events <i class="float-right cil-calendar"></i>
            </div>
            <div class="card-body text-center">
